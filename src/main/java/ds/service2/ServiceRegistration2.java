...
public class ServiceRegistration2 {
 ...
 public static void main(String[] args) throws InterruptedException {
     try {
         ...
         service2.startMe();  //NEEDED to start my service1

         // Register a service with the type _http._tcp.local.
         ServiceInfo serviceInfo = ServiceInfo.create("_http._tcp.local.", "LIBRARY_S2", 50052, "path=index.html");
